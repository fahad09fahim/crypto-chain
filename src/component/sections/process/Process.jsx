...
const Process = () => {
  return (
    ...
    >
      <div className="m-24 flex justify-center items-center flex-col text-center">
        <h1 className="text-center text-5xl font-bold mb-32">
          {" "}
          How To <span className="text-purple-600">Process</span>
        </h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="card w-[500px] bg-base-100  shadow-lg hover:shadow-colorTwo  transition-shadow duration-500">
            <figure>
              <img src={walletImg} alt="Shoes" />
            </figure>
            <div className="card-body">
              <h2 className="text-lg font-bold hover:text-colorOne ">
                Connect your Wallet
              </h2>
              <p>
          ...
          <div className="card w-[500px] bg-base-100 shadow-lg hover:shadow-colorTwo transition-shadow duration-500 flex  items-center">
            <figure>
